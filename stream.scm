...
(define (stream-first v)
  (first (force v)))
(define stream-second (cut stream-ref <> 1))
(define stream-third (cut stream-ref <> 2))
(define stream-fourth (cut stream-ref <> 3))
(define stream-fifth (cut stream-ref <> 4))
(define stream-sixth (cut stream-ref <> 5))
(define stream-seventh (cut stream-ref <> 6))
(define stream-eighth (cut stream-ref <> 7))
(define stream-ninth (cut stream-ref <> 8))
(define stream-tenth (cut stream-ref <> 9))
